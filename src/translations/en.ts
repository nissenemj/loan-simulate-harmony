...
export const en = {
  ...
  calculator: {
    ...
    debtName: "Debt Name",
    debtNamePlaceholder: "e.g., Home Loan",
    balance: "Balance",
    interestRate: "Interest Rate (%)",
    ...
    snowball: "Snowball",
    avalancheStrategy: "Avalanche Strategy",
    avalancheDescription: "Pay debts with highest interest rates first to minimize total interest paid.",
    snowballStrategy: "Snowball Strategy",
    snowballDescription: "Pay smallest debts first to gain momentum and psychological wins.",
    additionalMonthlyPayment: "Additional Monthly Payment",
    additionalPaymentDescription: "Extra amount above minimum payments to accelerate your debt payoff.",
    totalMonthlyPayment: "Total Monthly Payment",
    paymentResults: "Payment Results",
    payoffDate: "Payoff Date",
    estimatedCompletion: "Estimated completion date",
    totalInterest: "Total Interest",
    interestPaid: "Total interest paid over the life of your debts",
    ...
    debtFreeMessage: "You're now debt-free. Keep up the good financial habits!",
    ...
    extraPaymentTip: "Tip: Target High-Interest Debts",
    extraPaymentTipDescription: "For maximum impact, make extra payments toward your highest interest debt.",
    option: "Option",
    term: "Term",
    potentialSavings: "Potential Savings",
    saved: "saved",
    more: "more",
    noDebtsAdded: "No debts have been added yet. Add some debts to see calculations.",
    timelineDescription: "See how your debts will be paid off month by month.",
    consolidationDescription: "Explore options to consolidate your debts into a single loan.",
    extraPaymentDescription: "See how making an extra payment affects your debt payoff.",
    consolidationDisclaimer: "These are estimates only",
    consolidationDisclaimerText: "Actual loan terms depend on your credit score, income, and other factors.",
    consolidationConsiderations: "Important Considerations",
    considerationFees: "Check for origination fees, balance transfer fees, or closing costs",
    considerationCredit: "Your credit score affects the interest rate you qualify for",
    considerationCollateral: "Secured loans (like home equity) put your assets at risk if you default",
    considerationBehavior: "Consolidation only works if you don't add new debt",
    personalLoan: "Personal Loan",
    balanceTransfer: "Balance Transfer Card",
    homeEquityLoan: "Home Equity Loan",
    debtConsolidationLoan: "Debt Consolidation Loan"
  },
  debtStrategies: {
    pageTitle: "Debt Repayment Strategies",
    pageDescription: "Explore different strategies to pay off your debt more efficiently and save money on interest.",
    noDebtAlert: "You haven't added any debts yet. Please add loans or credit cards to use these tools.",
    calculateFirst: "Please use the calculator tab first to generate a payment plan."
  },
  summary: {
    totalLoans: "Total Loans",
