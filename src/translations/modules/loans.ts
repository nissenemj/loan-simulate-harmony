...
export const loans = {
	en: {
		loan: {
			...
			summaryTitle: "Summary of all loans with payment information",
			loanName: "Loan Name",
			monthlyPayment: "Monthly Payment",
			...
			total: "Total",
			potentialInterestSavings: "Potential Interest Savings",
			payOffNowSaves: "Paying off now saves",
			payOff: "Pay Off",
			payOffRecommendation:
				"These loans would save you the most interest if you paid them off now.",
		},
	},
	fi: {
		loan: {
			...
			summaryTitle: "Yhteenveto kaikista lainoista maksutietoineen",
			loanName: "Lainan nimi",
			monthlyPayment: "Kuukausimaksu",
			monthlyInterest: "Kuukausittaiset korot",
			totalInterestEstimate: "Kokonaiskorot arvio",
			totalPayableAmount: "Maksettava kokonaissumma",
			total: "Yhteensä",
			potentialInterestSavings: "Mahdolliset korkosäästöt",
			payOffNowSaves: "Maksamalla nyt säästät",
			payOff: "Maksa pois",
			payOffRecommendation:
				"Nämä lainat säästäisivät sinulle eniten korkoa, jos maksaisit ne pois nyt.",
		},
	},
};
