  ...
  en: {
    landing: {
      ...
      hero: {
        ...
        subheadline: "Create a clear path to financial freedom with our simple debt payoff tools",
      ...
      benefits: {
        ...
        item1: {
          ...
          description: "Create a tailored debt repayment plan using avalanche or snowball method."
        },
        item2: {
          title: "Track Your Progress",
          description: "Visualize your progress with interactive timeline and stay motivated."
        },
        item3: {
      ...
      methods: {
        ...
        avalanche: {
          ...
          description: "The avalanche method focuses on paying off highest interest debts first while making minimum payments on other debts.",
          benefit1: "Mathematically optimal - saves the most in interest payments",
        ...
        snowball: {
          title: "Debt Snowball",
          description: "The snowball method focuses on paying off smallest debts first to create momentum and motivation.",
          ...
          imageAlt: "Stack of coins growing larger depicting the snowball effect"
        }
      },
      faq: {
        title: "Frequently Asked Questions",
        question1: "How does the app work?",
        answer1: "Input your debts, including loan amounts, interest rates, and minimum payments. The app calculates an optimal repayment plan based on your chosen method (avalanche or snowball) and shows you when you'll be debt-free.",
        ...
        answer3: "Absolutely! The app works with any type of loan, including student loans, credit cards, personal loans, auto loans, and mortgages.",
        question4: "What's the difference between avalanche and snowball methods?",
        answer4: "The avalanche method prioritizes paying off high-interest debts first to save the most on interest costs. The snowball method focuses on paying off smallest debts first to create momentum and motivation."
      },
      finalCta: {
    ...
    landing: {
      ...
      hero: {
        ...
        subheadline: "Luo selkeä polku taloudelliseen vapauteen helppokäyttöisillä velanmaksutyökaluilla",
      ...
      faq: {
        ...
        answer2: "Kyllä! Velkavapaus.fi on täysin ilmainen käyttää. Uskomme, että kaikilla tulisi olla pääsy työkaluihin, jotka auttavat parantamaan taloudellista tilannettaan.",
