...
export const contact = {
  en: {
    ...
    title: "Contact Us",
    metaDescription: "Contact the Velkavapaus team for assistance with debt-related questions or technical support.",
    ...
    title: "Ota yhteyttä",
    metaDescription: "Ota yhteyttä Velkavapaus-tiimiin saadaksesi apua velkakysymyksiin tai teknistä tukea.",
