...
export const fi = {
  ...
  // Luottokortteihin liittyvät tekstit
  creditCard: {
  ...
  landing: {
    ...
    methods: {
      ...
      snowball: {
        title: "Velkalumipallo",
        description: "Velkalumipallomenetelmä keskittyy maksamaan pienimmät velat ensin momentin ja motivaation luomiseksi.",
  ...
  // Taloussanastoon liittyvät tekstit
  loanTerms: {
  ...
  // Kielenvalintaan liittyvät tekstit
  language: {
    en: "Englanti",
    fi: "Suomi",
  },

  // Validointiviestien tekstit
  validation: {
  ...
  // Takaisinmaksutapoihin liittyvät tekstit
  repayment: {
    annuity: "Annuiteetti",
  ...
  // Korkotyyppeihin liittyvät tekstit
  interest: {
    fixed: "Kiinteä",
  ...
  // Kirjautumiseen liittyvät tekstit
  auth: {
