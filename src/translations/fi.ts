...
export const fi: typeof en = {
  ...
  dashboard: {
    ...
    progress: "Takaisinmaksun edistyminen",
    debtBreakdown: "Velkaeritelmä",
    minPayment: 'Vähimmäismaksu',
    budget: 'Budjetti',
    extraPayment: 'Lisämaksu',
    payoffHighestInterest: 'Maksaa korkein korko ensin',
    loans: 'Lainat',
    creditCards: 'Luottokortit',
    financialTips: 'Taloudelliset vinkit',
    tip1: 'Maksaa ensin korkein korko',
    tip2: 'Harkitse uudelleenrahoitusta',
    tip3: 'Luo budjetti ja pidä kiinni siitä',
    glossary: 'Sanasto',
    viewGlossary: 'Näytä sanasto',
    ...
    equalDistribution: 'Tasaisen jakelun strategia',
