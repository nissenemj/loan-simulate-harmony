...
export const fi: typeof en = {
  ...
  dashboard: {
    title: "Kojelauta",
    welcome: "Tervetuloa",
    welcomeSubtitle: "Tarkastele taloudellista tilaasi yhdellä silmäyksellä",
    user: "käyttäjä",
    viewDebtSummary: "Tarkastele velkatiivistelmää",
    debtFreeTimeline: "Velaton aikajana",
    timelineDescription: "Seuraa velkaasi ajan myötä ja näe, milloin olet velaton",
    debtFree: "Velaton",
