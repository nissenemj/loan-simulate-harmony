...
export const fi: typeof en = {
  ...
  dashboard: {
    ...
    tipTitle1: 'Maksa korkein korko ensin',
    tipContent1: 'Kohdista ylimääräinen maksu korkeimmalla korolla olevaan velkaan säästääksesi korkokuluissa.',
    tipTitle2: 'Aseta automaattimaksut',
    tipContent2: 'Aseta automaattimaksut varmistaaksesi, että minimierät maksetaan ajallaan.',
    tipTitle3: 'Tarkista lainan uudelleenrahoitusmahdollisuudet',
    tipContent3: 'Tarkista voitko uudelleenrahoittaa nykyisiä lainojasi alemmalla korolla.',
    tipTitle4: 'Rakenna hätärahasto',
    tipContent4: 'Pyri rakentamaan 3-6 kuukauden hätärahasto samalla kun maksat velkojasi.',
    strategyTitle: 'Velanmaksustrategia',
    strategyAvalanche: 'Lumivyöry',
    strategySnowball: 'Lumipallo',
    strategyDescription: 'Strategiat velan takaisinmaksuun',
    avalancheDescription: 'Maksa korkeakorkoinen velka ensin.',
    snowballDescription: 'Maksa pienin velka ensin.',
    strategySummary: 'Optimaalisin strategiasi',
    customizeStrategy: 'Muokkaa strategiaa',
    debtFreeSummary: 'Velaton yhteenveto',
