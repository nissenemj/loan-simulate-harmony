...
const allKeys = new Set([
	...
	...Object.keys(fiTranslations),
]);
const missingInFi = Array.from(allKeys).filter(
	(key) => !fiTranslations[key] && enTranslations[key]
);
const missingInEn = Array.from(allKeys).filter(
	(key) => !enTranslations[key] && fiTranslations[key]
);
