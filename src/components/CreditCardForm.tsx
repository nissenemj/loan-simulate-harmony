						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									...
									<FormItem>
										...
										<FormControl>
											<div className="relative">
												...
												<Input
													placeholder={t(
														"form.creditCard.form.placeholderName"
													)}
										...
										<FormControl>
											<div className="relative">
												...
												<Input
													type="number"
													placeholder={t(
														"form.creditCard.form.placeholderBalance"
													)}
													className="pl-10 dark:bg-bg-elevated dark:border-bg-highlight"
													step="0.01"
													{...field}
										...
										<FormControl>
											<div className="relative">
												...
												<Input
													type="number"
													placeholder={t(
														"form.creditCard.form.placeholderCreditLimit"
													)}
													className="pl-10 dark:bg-bg-elevated dark:border-bg-highlight"
													step="0.01"
													{...field}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel>
											{t("form.creditCard.form.minPaymentPercent")}
										</FormLabel>
										<FormControl>
											<div className="relative">
												<div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-muted-foreground">
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel>
											{t("form.creditCard.form.minPayment")}
										</FormLabel>
										<FormControl>
											<div className="relative">
												<div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-muted-foreground">
												...
												<Input
													type="number"
													placeholder={t(
														"form.creditCard.form.placeholderMinPayment"
													)}
