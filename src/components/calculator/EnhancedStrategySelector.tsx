  ...
  const strategies = [
    {
      ...
      title: t('repayment.avalancheMethod'),
      description: t('repayment.avalancheDescription'),
      benefits: [
        t('repayment.avalancheBenefit1'),
        t('repayment.avalancheBenefit2')
      ],
      icon: TrendingDown,
    ...
    },
    {
      ...
      title: t('repayment.snowballMethod'),
      description: t('repayment.snowballDescription'),
      benefits: [
        t('repayment.snowballBenefit1'),
        t('repayment.snowballBenefit2')
      ],
  ...
  return (
    <div className={cn("space-y-4", className)}>
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="text-lg font-medium">{t('repayment.chooseStrategy')}</h3>
      </div>
          ...
          return (
            ...
            >
              <CardContent className="p-4 md:p-6">
                ...
                <div className="mt-4">
                  <h5 className="text-sm font-medium mb-2">{t('repayment.benefits')}</h5>
