...
const AffiliateBanner: React.FC<AffiliateBannerProps> = ({
  ...
  return <Card className={`mb-4 border-0 shadow-none ${className}`}>
      <CardContent className="p-2 flex justify-center">
        {banner.htmlContent ? <div onClick={handleClick} dangerouslySetInnerHTML={{
        __html: banner.htmlContent
      }} className="cursor-pointer" /> : <a href={banner.url} target="_blank" rel="noopener noreferrer" onClick={handleClick}>
